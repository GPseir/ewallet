...
describe('Wallet', () => {
    ...
    test('creates an input into or withdraw from the balance', () => {
    ...
    describe('when the user types into the wallet input', () => {
        ...
        describe('and the user wants to make a deposit', () => {
            ...
            test('dispatches the `deposit()` it receives from the props with the local balance', () => {
        ...
        describe('and the user wants to make a withdrawal', () => {
            ...
            test('dispatches the `withdraw()` it receives from the props with the local balance', () => {
